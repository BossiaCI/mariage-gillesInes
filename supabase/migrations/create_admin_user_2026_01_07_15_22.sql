...
COMMENT ON FUNCTION public.handle_new_admin_user() IS 'Crée automatiquement un utilisateur admin lors de l\'inscription avec un email autorisé';
COMMENT ON FUNCTION public.is_admin(UUID) IS 'Vérifie si un utilisateur a les droits d\'administrateur';
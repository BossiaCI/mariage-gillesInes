...
-- Insérer quelques photos d'exemple avec les nouvelles sous-catégories
INSERT INTO public.wedding_photos_2026_01_13 (filename, original_name, file_path, category, sous_categorie, description, is_featured, display_order) VALUES
('hero-accueil.jpg', 'Background Page Accueil', 'demo/hero-accueil.jpg', 'background', 'accueil', 'Photo de fond pour la page d''accueil', true, 1),
('hero-rsvp.jpg', 'Background Page RSVP', 'demo/hero-rsvp.jpg', 'background', 'rsvp', 'Photo de fond pour la page RSVP', false, 2),
('couple-histoire.jpg', 'Photo Couple Histoire', 'demo/couple-histoire.jpg', 'illustration', 'couple', 'Photo du couple pour la page Notre Histoire', false, 3),
('contact-photo.jpg', 'Photo Contact', 'demo/contact-photo.jpg', 'illustration', 'contact', 'Photo pour la page Contact', false, 4)
